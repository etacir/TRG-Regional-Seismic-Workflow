...
save('DRM_input_data.mat','ut','wt');
% save('DRM_input_data_Ricker.mat','ut','wt');

% Velo_info_X = 
[U,V] = fun_GetResponse_layer_2D(t,t_int,coords,Angle,Node_0,Surface_z,Layer_info,Velo_info_X,Velo_info_Y);
