function [U,V] = fun_GetResponse_layer_2D_damp(t,t_int,coords,angle,Node_0,Surface_z,Layer_info,u,w,Ralpha,Rbeta)
...
Beta = (asind(Vs(Layer_ID)/Vs(end)*sind(angle)));
Alpha = (asind(Vp(Layer_ID)/Vs(Layer_ID)*sind(Beta)));
